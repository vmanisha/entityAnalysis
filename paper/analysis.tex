...
\begin{itemize}
\item \fbox{\textbf{first citizens bank} and trust \textbf{raleigh nc}} is annotated with the entities 
...
\item \fbox{\textbf{tennessee walking horses} in \textbf{missouri}} is annotated with the entities  \texttt{Missouri} and  \texttt{Tennessee\_Walking\_Horse};
\item \fbox{\textbf{i love you} \textbf{remix} featuring \textbf{jim jones} and \textbf{black rob}} is annotated with the entities  \texttt{I\_Love\_You,\_Man}, \texttt{Remix}, \texttt{Jim\_Jones\_(rapper)}, \texttt{Black\_Rob}.
 \end{itemize}
...
queries contains both head and tail entities. Moreover, this percentage gradually rises with the 
...
\label{img:headTailEntPercent}
  \centering
	...
	\caption{Percentage of queries with either only head, only tail or both entities}
