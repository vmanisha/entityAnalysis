...
\documentclass{style/sig-alternate}[9pt]
...
\conferenceinfo{ESAIR'14,}{November 07 2014, Shanghai, China}
\CopyrightYear{2014}
\crdata{978-1-4503-1365-0/14/11 \\
...
\title{Bringing Head Closer to the Tail with Entity Linking}
...
\email{ diego.ceccarelli@isti.cnr.it}\\
% % 2nd. author
...
With the creation and rapid development of knowledge bases, it has become easier
 ...
 Search queries follow a Zipfian distribution wherein other than few popular queries 
...
%Search queries are primary means of finding information. While a handful of 
 ...
 In this work we focus on quantifying the extent of overlap between long tail
